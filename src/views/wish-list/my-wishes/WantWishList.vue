<template>
    <div>
        ...
        <div>
            ...
            <div class="flex flex-options" v-if="wishes.length">
                <div class="select">
                        ...
                        <div class="add-box">
                            ...
                            <form class="form" method="post" @submit.prevent="addWishList">
                                    ...
                                    <n-space vertical class="select">
                                        <n-select v-model:value="newWish.visible" :options="visible" class="form-n-select" />
                                    </n-space>

                                    <label>Статус*</label>
                                    <n-space vertical class="select">
                                        <n-select v-model:value="newWish.done" :options="done" class="form-n-select" />
                                    </n-space>

                                    <n-button strong secondary type="success" attr-type="submit" class="add-btn" @click="showModal=false; addWishList(); activate('top')">Добавить желание</n-button>
                            </form>
                        </div>
                    </div>
